...
{
	Lcd_Clear(GRAY0);
	Gui_DrawFont_GBK16(16,10,BLUE,GRAY0,"文文文文文文");

	delay_ms(1000);
	Lcd_Clear(GRAY0);
	Gui_DrawFont_GBK16(16,30,YELLOW,GRAY0,"全全全全全全");
	Gui_DrawFont_GBK16(16,50,BLUE,GRAY0,"专专专专专专");
	Gui_DrawFont_GBK16(16,70,RED,GRAY0, "程程程程程程");
	Gui_DrawFont_GBK16(0,100,BLUE,GRAY0,"Tel:1898989898");
	Gui_DrawFont_GBK16(0,110,RED,GRAY0, "www.qdtech.net");	
	delay_ms(1800);	
}
